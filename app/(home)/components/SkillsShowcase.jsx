...
import { SiExpress, SiMongodb, SiTailwindcss, SiFigma, SiFlask, SiMysql, SiJavascript, SiTypescript, SiNextdotjs } from 'react-icons/si';
...
const skills = [
    ...
    { name: "React.js", icon: <FaReact className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 sm:row-span-2 row-span-1" },
    { name: "Next.js", icon: <SiNextdotjs className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Flask", icon: <SiFlask className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    ...
    { name: "MySQL", icon: <SiMysql className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
